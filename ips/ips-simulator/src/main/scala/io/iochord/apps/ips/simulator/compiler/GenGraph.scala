...
class GenGraph {
   ...
   * @return
   * 
   * Create graph with specific number of transition (each transition will have 2 input arc and 1 output arc)
   */
   ...
   * @return
   * 
   * Create port model from my database (only used for testing)
   */
