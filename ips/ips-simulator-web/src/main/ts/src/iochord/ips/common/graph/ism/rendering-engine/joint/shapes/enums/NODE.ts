...
export const NODE_TYPE = {
  ...
  and_join: {
    image: require('@/assets/images/icons/20190626-FIX_ICON/64x64/branch/branch_and_join_64.png'),
    markup: '<g class="rotatable"><g class="scalable"><rect class="root"/></g></g><text class="label"/>',
    size: { width: 64, height: 64 },
    attr: {
      '.root' : {
  ...
  and_split: {
    image: require('@/assets/images/icons/20190626-FIX_ICON/64x64/branch/branch_and_split_64.png'),
    markup: '<g class="rotatable"><g class="scalable"><rect class="root"/></g></g><text class="label"/>',
    size: { width: 64, height: 64 },
    attr: {
      '.root' : {
  ...
  xor_join: {
    image: require('@/assets/images/icons/20190626-FIX_ICON/64x64/branch/branch_xor_join_64.png'),
    markup: '<g class="rotatable"><g class="scalable"><rect class="root"/></g></g><text class="label"/>',
    size: { width: 64, height: 64 },
    attr: {
      '.root' : {
  ...
  xor_split: {
    image: require('@/assets/images/icons/20190626-FIX_ICON/64x64/branch/branch_xor_split_64.png'),
    markup: '<g class="rotatable"><g class="scalable"><rect class="root"/></g></g><text class="label"/>',
    size: { width: 64, height: 64 },
    attr: {
      '.root' : {
