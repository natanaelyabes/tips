  ...
  <div class="content split component">
    <SplitContentWrapperComponent>
      ...
      <template slot="content-right">
        <div class="ui basic segment">
        <h4 class="ui dividing header">Fitted</h4>
          parameters
        </div>
      </template>
    </SplitContentWrapperComponent>
...
import SplitContentWrapperComponent from '@/iochord/chdsr/common/ui/layout/components/SplitContentWrapperComponent.vue';
