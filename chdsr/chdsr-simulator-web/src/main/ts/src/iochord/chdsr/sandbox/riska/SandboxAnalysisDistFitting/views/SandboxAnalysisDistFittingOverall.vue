  ...
  <div class="sandbox analysis dist fitting">
    <LeftBarContentWrapperComponent>
      ...
      <template slot="left-bar-menu-item">
        <!-- <div class="menu"> -->
          <a href="/#/iochord/chdsr/sandbox/sandbox-analysis-dist-fitting-settings" class="item">Settings</a>
          <a href="/#/iochord/chdsr/sandbox/sandbox-analysis-dist-fitting-overall" class="item">Overall</a>
        <!-- </div> -->
      </template>
