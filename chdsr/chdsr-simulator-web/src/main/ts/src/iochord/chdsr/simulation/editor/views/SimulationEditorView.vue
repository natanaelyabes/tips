  ...
  <div class="editor view">
    ...
    <template v-for="type in Array.from(nodeTypes)">
      <template v-if="type === 'start'">
        ...
        @changeStartLabel = "changeStartLabel($event)" 
        @changeGenerator = "changeGenerator($event)"
      ...
      <template v-if="type === 'stop'">
        <StopNodeModal 
        @changeStopLabel = "changeStopLabel($event)" 
...
export default class SimulationEditorView extends Vue implements ApplicationHasWrapper {
  ...
  public parentReport: boolean = false;
  ...
  public changeStartLabel(e: any){
    this.parentStartLabel = e;
  }

  public changeGenerator(e: any){
    this.parentGenerator = e;
  }
  ...
  public changeStopLabel(e: any){
    this.parentStopLabel = e;
  }

  public changeReport(e: any){
    this.parentReport = e;
  }
  ...
  public async testGraphDataStruct(): Promise<void> {
    try {
      ...
      const response = await axios.get('http://164.125.62.134:3001/chdsr/api/v1/model/example');
