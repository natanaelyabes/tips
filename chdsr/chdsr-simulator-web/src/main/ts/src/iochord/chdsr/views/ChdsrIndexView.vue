      ...
      <div slot="sidebar-menu">
        ...
        <div class="item">
          ...
          <div class="menu">
            ...
            <router-link tag="a" class="item" to="#">Run Simulation <i class="play circle outline icon"></i></router-link>
            <router-link tag="a" class="item" to="#">Animation <i class="running icon"></i></router-link>
...
export default class Index extends Vue implements VueHasLifeCycleInterface, SemanticModulesIsUsedInterface {
