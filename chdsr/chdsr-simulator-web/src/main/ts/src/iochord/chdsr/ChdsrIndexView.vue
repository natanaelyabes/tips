      ...
      <div slot="sidebar-menu">
        ...
        <div class="item">
          ...
          <div class="menu">
            ...
            <router-link tag="a" class="item" to="/iochord/chdsr/data-connection">Connection / Import</router-link>
            <router-link tag="a" class="item" to="/iochord/chdsr/data-filter">Filter</router-link>
            <router-link tag="a" class="item" to="/iochord/chdsr/data-mapping">Mapping</router-link>
            <router-link tag="a" class="item" to="/iochord/chdsr/data-history">History / Browser</router-link>
          </div>
        </div>
        <div class="item">
          <div class="header" style="text-decoration:underline">Analysis / Algorithm</div>
          <div class="menu">
            <router-link tag="a" class="item" to="/iochord/chdsr/analysis-process-model">Process Model</router-link>
            <router-link tag="a" class="item" to="/iochord/chdsr/analysis-branches-mining">Branches Mining</router-link>
            <router-link tag="a" class="item" to="/iochord/chdsr/analysis-resource-mining">Resource Mining</router-link>
            <router-link tag="a" class="item" to="/iochord/chdsr/analysis-distribution-fitting">Distribution Fitting</router-link>
          </div>
        </div>
        <div class="item">
