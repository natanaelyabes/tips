            ...
            <div class="ui card">
              ...
              <div class="extra content">
                <div class="left floated">
                  <span><router-link to="/bsclab/synchronous/wiki/getting-started"><i class="info icon"></i>Help</router-link></span>
                </div>
              </div>
            </div>
            <div class="ui card">
              <div class="content">
                <h2 class="left floated">Recent Simulations</h2>
                <div class="right floated">
                  <div class="ui basic compact icon button"><i class="plus icon"></i></div>
                </div>
                <div class="description">
              ...
              <div class="extra content">
                <div class="left floated">
                  <span><router-link to="/bsclab/synchronous/workflow/models" tag="a"><i class="ellipsis horizontal icon"></i>More</router-link></span> &nbsp;
                  <span><a href="#"><i class="filter icon"></i> Filter</a></span>
                </div>
              </div>
            </div>
            <div class="ui card">
              <div class="content">
                <h2 class="left floated">Recent Files</h2>
                <div class="right floated">
                  <div class="ui basic compact icon button"><i class="plus icon"></i></div>
                </div>
                <div class="description">
              ...
              <div class="extra content">
                <div class="left floated">
                  <span><router-link to="/bsclab/synchronous/workflow/instances" tag="a"><i class="ellipsis horizontal icon"></i>More</router-link></span> &nbsp;
                  <span><a href="#"><i class="filter icon"></i> Filter</a></span>
                </div>
              </div>
            </div>
...
// Enums
import { ApplicationEnum } from '@/iochord/chdsr/enums/index';

// Interfaces
import { VueHasLifeCycleInterface } from '@/iochord/chdsr/common/vue/interfaces/VueHasLifeCycleInterface';
import { SemanticModulesIsUsedInterface } from '@/iochord/chdsr/common/ui/semantic/interfaces/SemanticModulesIsUsedInterface';
import { BrowserHasPropertiesInterface } from '@/iochord/chdsr/common/browser/interfaces/BrowserHasPropertiesInterface';
...
export default class Home extends Vue implements VueHasLifeCycleInterface, SemanticModulesIsUsedInterface, BrowserHasPropertiesInterface {
